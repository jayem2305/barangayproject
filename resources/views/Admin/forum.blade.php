...
<!-- Spinner End -->
        ...
        <nav class="navbar navbar-expand-lg p-lg-0"style="background-color: #1C2035;">
            <button type="button" class="navbar-toggler me-0" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="statisticalreport" class="nav-item nav-link text-white"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-up" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M0 0h1v15h15v1H0zm14.817 3.113a.5.5 0 0 1 .07.704l-4.5 5.5a.5.5 0 0 1-.74.037L7.06 6.767l-3.656 5.027a.5.5 0 0 1-.808-.588l4-5.5a.5.5 0 0 1 .758-.06l2.609 2.61 4.15-5.073a.5.5 0 0 1 .704-.07"/>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item bg-primary text-white" href="forum" class="nav-item nav-link text-white "><i class="bi bi-info-circle"></i> Forum</i></a></li>
                    </ul>
                </li>
            ...
            <div>
                <div class="mb-3">
                    <div class="row">
                        ...
                        <label for="exampleFormControlInput1" class="form-label" id="labelname"><b></b><span class="text-danger"></span></label>
                        </div>
                        <div class="col-lg-12">
                        <div class="mb-3 d-grid gap-2 d-md-flex justify-content-md-end">
                        <input type="text" class="form-control" id="commnent" placeholder="Write a Comment" name="commnent">
                        <button type="submit" class="btn btn-primary btn-comment" data-topic="#commnent"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send-fill" viewBox="0 0 16 16">
